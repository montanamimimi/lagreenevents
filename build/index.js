...
/* harmony export */ });
/* harmony import */ var _utils_gtm_cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/gtm_cookie */ "./src/js/utils/gtm_cookie.js");
...
class Calculator {
  ...
  async sendForm() {
    ...
    if (!err) {
      const cookie = (0,_utils_gtm_cookie__WEBPACK_IMPORTED_MODULE_0__.loadCookie)();
...
class Source {
  constructor() {
    ...
    this.cookieDays = 90;
    this.params = ['utm_source', 'utm_campaign_id', 'utm_adgroup_id', 'utm_term', 'gclid'];
    this.data = {};
  }
  init() {
  ...
  saveCookie() {
    ...
    document.cookie = `${this.cookieName}=` + encodeURIComponent(JSON.stringify(this.data)) + `; expires=${expires.toUTCString()}; path=/; SameSite=Lax`;
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ WhatsApp)
/* harmony export */ });
/* harmony import */ var _utils_gtm_cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/gtm_cookie */ "./src/js/utils/gtm_cookie.js");
  ...
  addListeners() {
    this.links.forEach(link => {
      link.addEventListener('click', async e => {
        this.cookie = (0,_utils_gtm_cookie__WEBPACK_IMPORTED_MODULE_0__.loadCookie)();
        e.preventDefault();
        const response = await fetch(ajax_object.ajax_url, {
          method: "POST",
          body: new URLSearchParams({
        ...
        if (response.status == 200) {
          ...
          const message = text.replaceAll('[id]', postId).replaceAll('[newline]', '\n');
...
/* harmony import */ var _js_Source__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/Source */ "./src/js/Source.js");
...
/* harmony import */ var _js_WhatsApp__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/WhatsApp */ "./src/js/WhatsApp.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  new _js_WhatsApp__WEBPACK_IMPORTED_MODULE_9__["default"]();
  const source = new _js_Source__WEBPACK_IMPORTED_MODULE_3__["default"]();
  source.init();
});
})();
